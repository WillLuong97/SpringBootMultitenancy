package com.willieluong.multitenant.config.multitenant.schema;
 ...
 *
 *
 * This class is to established a connection from the tenant with the server
 *
 * **/
@Component
public class TenantConnectionProvider implements MultiTenantConnectionProvider {
    ...
    //return the specific connection info from the tenant
    @Override
